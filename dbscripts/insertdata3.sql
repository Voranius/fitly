...
INSERT INTO `fitlydb`.`class` (`name`, `details`, `address1`, `neighbourhood`, `minsize`, `instructions`, `category`, `creator_id`) VALUES ('Crossfit for Beginners', 'A high-intensity fitness program incorporating elements from several sports and exercises.', '250 Ayer Rajah Crescent', 'Ayer Rajah', 10, 'Bring your own towel.', 'Crossfit', 1);
INSERT INTO `fitlydb`.`class` (`name`, `details`, `address1`, `neighbourhood`, `minsize`, `instructions`, `category`, `creator_id`) VALUES ('Extreme Crossfit', 'An hour-long brutal X-fit workout to test the limits of your strength, speed and endurance.', '250 Ayer Rajah Crescent', 'Ayer Rajah', 10, 'Participants must have attended Crossfit for Beginners', 'Crossfit', 1);
INSERT INTO `fitlydb`.`class` (`name`, `details`, `address1`, `neighbourhood`, `minsize`, `instructions`, `category`, `creator_id`) VALUES ('Core Workouts For A Tight Midsection', 'We will introduce 5 easy-to-follow workouts to help strengthen your midsection', '116A Tampines Ave 2 #01-116', 'Tampines', 8, 'Shower facility availalable', 'Core', 2);
INSERT INTO `fitlydb`.`class` (`name`, `details`, `address1`, `neighbourhood`, `minsize`, `instructions`, `category`, `creator_id`) VALUES ('Silver-ready Free-weights', 'Resistance exercises to strengthen your muscles, maintain healthy bone mass and prevent age-related muscle loss', '67 Jurong East St 11', 'Jurong East', 5, 'Ask your doctor if there are any precautions you should take', 'Weights', 3);
