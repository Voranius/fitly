// model definition of 'client' table in 'fitlydb' database
module.exports = function(database, Sequelize) {
    // 'client' is the same name as the SQL table
    var Client = database.define('client', {
        // map everything here just like it is on table 'client'
            id: {
            ...
            // 'client' is the table name on the 'fitlydb' database
            tableName: 'client',
